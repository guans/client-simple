...
public class PDRService extends Service {
	...
	/**粒子滤波*/
    ParticleFilter particleFilter = null;//new ParticleFilter(0.8, 8.8);
	...
	public void onCreate() {
		// TODO Auto-generated method stub
		super.onCreate();
		particleFilter=new ParticleFilter(0.8,8.8);
...
*/
	...
	public void onStart(Intent intent, int startId) {
		// TODO Auto-generated method stub
		//particleFilter=new ParticleFilter(MapNavigateContants.URADIOLOCATION.getXCoordinate(),MapNavigateContants.URADIOLOCATION.getYCoordinate());
